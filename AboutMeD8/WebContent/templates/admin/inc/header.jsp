...
<head>
  ...
  <!-- CSS Files -->
  <link href="<%=request.getContextPath()%>/templates/admin/assets/css/material-dashboard.css?v=2.1.0" rel="stylesheet" />
  <!-- CSS Just for demo purpose, don't include it in your project -->
  <link href="<%=request.getContextPath()%>/templates/admin/assets/demo/demo.css" rel="stylesheet" />
